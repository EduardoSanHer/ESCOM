...
_0x10:
	BLD  R2,1
; 0000 0092 
; 0000 0093 if((botonp == 1) && (botona == 0)){ //Flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,1
	RJMP _0xA
...
; 0000 0098 }
; 0000 0099 
; 0000 009A if((botonp == 0) && (botona == 1)) //Flanco de 0 a 1
_0x8:
	SBRC R2,0
	RJMP _0xD
	SBRC R2,1
...
; 0000 009B delay_ms(40);
	...
	RCALL _delay_ms
; 0000 009C 
; 0000 009D PORTB = tabla7segmentos[variable];
_0xC:
	RCALL SUBOPT_0x0
	LPM  R0,Z
	OUT  0x18,R0
; 0000 009E PORTA = ~tabla7segmentos[variable];
	RCALL SUBOPT_0x0
	LPM  R30,Z
	COM  R30
	OUT  0x1B,R30
; 0000 009F 
; 0000 00A0 botonp = botona;
	BST  R2,1
	BLD  R2,0
; 0000 00A1 
; 0000 00A2 }
