...
; 0000 0096 // ADC Clock frequency: 500.000 kHz
; 0000 0097 // ADC Voltage Reference: AREF pin
; 0000 0098 // ADC High Speed Mode: Off
...
; 0000 009C ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 009D ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(129)
	OUT  0x6,R30
; 0000 009E SFIOR=(1<<ADHSM) | (0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(16)
	OUT  0x30,R30
; 0000 009F 
...
; 0000 00A9 {
; 0000 00AA /*if(aux1){
; 0000 00AB valorADC = read_adc(0);
; 0000 00AC valorFinal = 50 * valorADC / 255;
; 0000 00AD aux1 = ~aux1;
; 0000 00AE }
; 0000 00AF else
; 0000 00B0 aux1 = ~aux1;*/
; 0000 00B1 valorADC = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOV  R5,R30
; 0000 00B2 valorFinal = 50 * valorADC / 255;
	LDI  R26,LOW(50)
	MUL  R30,R26
	MOVW R30,R0
	MOVW R26,R30
...
; 0000 00B4 if(mux){
	SBRS R2,0
	RJMP _0x9
; 0000 00B5 PORTB = tabla7segmentos [valorFinal/10];
	MOV  R26,R4
	LDI  R27,0
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __DIVW21
	RCALL SUBOPT_0x0
; 0000 00B6 PORTC = 0x02;
	LDI  R30,LOW(2)
	RJMP _0xC
; 0000 00B7 }
; 0000 00B8 else{
_0x9:
; 0000 00B9 PORTB = tabla7segmentos [valorFinal%10];
	MOV  R26,R4
	CLR  R27
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
