...
; 0000 00A8 {
; 0000 00A9 /*if(aux1){
; 0000 00AA valorADC = read_adc(0);
; 0000 00AB valorFinal = 50 * valorADC / 255;
; 0000 00AC aux1 = ~aux1;
; 0000 00AD }
; 0000 00AE else
; 0000 00AF aux1 = ~aux1;*/
; 0000 00B0 valorADC = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	CLR  R31
	CLR  R22
	...
	STS  _valorADC+2,R22
	STS  _valorADC+3,R23
; 0000 00B1 valorFinal = 300 * valorADC / 255;
	__GETD2N 0x12C
	RCALL __MULD12U
	MOVW R26,R30
	MOVW R24,R22
	...
	RCALL __DIVD21U
	STS  _valorFinal,R30
	STS  _valorFinal+1,R31
	STS  _valorFinal+2,R22
	STS  _valorFinal+3,R23
; 0000 00B2 
; 0000 00B3 if(mux == 0){
	MOV  R0,R4
	OR   R0,R5
	BRNE _0x9
; 0000 00B4 PORTB = tabla7segmentos [valorFinal/100];
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 00B5 PORTC = 0x06;
	LDI  R30,LOW(6)
	RJMP _0x10
; 0000 00B6 }
; 0000 00B7 else if(mux == 1){
_0x9:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0xB
; 0000 00B8 PORTB = tabla7segmentos [valorFinal%100/10];
	RCALL SUBOPT_0x0
	RCALL __MODD21U
	MOVW R26,R30
	MOVW R24,R22
	RCALL SUBOPT_0x2
	RCALL SUBOPT_0x1
; 0000 00B9 //PORTB = tabla7segmentos [(valorFinal-100)/10];
; 0000 00BA PORTC = 0x05;
	LDI  R30,LOW(5)
	RJMP _0x10
; 0000 00BB }
; 0000 00BC else if(mux == 2){
_0xB:
	LDI  R30,LOW(2)
	LDI  R31,HIGH(2)
	CP   R30,R4
	CPC  R31,R5
	BRNE _0xD
; 0000 00BD PORTB = tabla7segmentos [valorFinal%10];
	LDS  R26,_valorFinal
	LDS  R27,_valorFinal+1
	LDS  R24,_valorFinal+2
	LDS  R25,_valorFinal+3
	RCALL SUBOPT_0x2
	RCALL __MODD21U
	...
	LPM  R0,Z
	OUT  0x18,R0
; 0000 00BE //PORTB = tabla7segmentos [(valorFinal-100)%10];
; 0000 00BF PORTC = 0x03;
	LDI  R30,LOW(3)
_0x10:
	OUT  0x15,R30
; 0000 00C0 }
