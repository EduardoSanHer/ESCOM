...
; 0000 0091 delay_ms(100);
	...
	RCALL SUBOPT_0x0
; 0000 0092 Salida = 0;
; 0000 0093 delay_ms(900);
	LDI  R26,LOW(900)
	LDI  R27,HIGH(900)
	RJMP _0x1E
; 0000 0094 } else if(Reversa == 0){
_0x6:
	SBIC 0x16,1
	RJMP _0xC
; 0000 0095 Salida = 1;
...
; 0000 009B delay_ms(300);
	...
	RCALL SUBOPT_0x0
; 0000 009C Salida = 0;
; 0000 009D delay_ms(700);
	LDI  R26,LOW(700)
	LDI  R27,HIGH(700)
	RJMP _0x1E
; 0000 009E } else if(Derecha == 0){
_0x12:
	SBIC 0x16,3
	RJMP _0x18
; 0000 009F Salida = 1;
	SBI  0x1B,0
; 0000 00A0 delay_ms(400);
	LDI  R26,LOW(400)
	LDI  R27,HIGH(400)
	RCALL SUBOPT_0x0
; 0000 00A1 Salida = 0;
; 0000 00A2 delay_ms(600);
	LDI  R26,LOW(600)
	LDI  R27,HIGH(600)
_0x1E:
	RCALL _delay_ms
