...
; 0000 0030 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0031 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
...
_0x3:
; 0000 008E {
; 0000 008F contador = 0;
	CLR  R4
	CLR  R5
; 0000 0090 for(i = 0; i < 1000; i++){
	CLR  R6
	CLR  R7
_0x7:
	LDI  R30,LOW(1000)
...
_0x8:
; 0000 0095 
; 0000 0096 if(contador >= 90 && contador <= 110){
	LDI  R30,LOW(90)
	LDI  R31,HIGH(90)
	RCALL SUBOPT_0x0
	BRLT _0xB
...
_0xB:
	RJMP _0xA
_0xC:
; 0000 0097 PORTA = Delante;
	LDI  R30,LOW(5)
	RJMP _0x1B
; 0000 0098 }else if(contador >= 190 && contador <= 210){
_0xA:
	LDI  R30,LOW(190)
	LDI  R31,HIGH(190)
	RCALL SUBOPT_0x0
...
_0xF:
	RJMP _0xE
_0x10:
; 0000 0099 PORTA = Reversa;
	LDI  R30,LOW(10)
	RJMP _0x1B
; 0000 009A }else if(contador >= 290 && contador <= 310){
_0xE:
	LDI  R30,LOW(290)
	LDI  R31,HIGH(290)
	RCALL SUBOPT_0x0
...
_0x13:
	RJMP _0x12
_0x14:
; 0000 009B PORTA = Izquierda;
	LDI  R30,LOW(1)
	RJMP _0x1B
; 0000 009C }else if(contador >= 350 && contador <= 410){
_0x12:
	LDI  R30,LOW(350)
	LDI  R31,HIGH(350)
	RCALL SUBOPT_0x0
