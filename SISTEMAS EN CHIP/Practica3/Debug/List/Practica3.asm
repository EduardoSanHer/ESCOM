...
_0x3:
; 0000 008C {
; 0000 008D variableB = PIND&0x0f;
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 008E if(variableB < 10) PORTB=tabla7segmentos[variableB];
	LDI  R30,LOW(10)
	CP   R4,R30
	BRSH _0x6
	MOV  R30,R4
	...
	LPM  R0,Z
	OUT  0x18,R0
; 0000 008F else PORTB = 0x79;
	RJMP _0x7
_0x6:
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 0090 
; 0000 0091 variableA = PINC&0x0f;
_0x7:
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 0092 PORTA = ~tabla7segmentos[variableA];
	LDI  R31,0
	SUBI R30,LOW(-_tabla7segmentos*2)
	SBCI R31,HIGH(-_tabla7segmentos*2)
	LPM  R30,Z
