...
; 0000 008E TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 008F if (datoaguardar>10)
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	CPI  R30,LOW(0xB)
	BRLO _0x3
; 0000 0090 datoaguardar=0;
	RCALL SUBOPT_0x0
	LDI  R30,LOW(0)
	RCALL __EEPROMWRB
; 0000 0091 var=datoaguardar;
_0x3:
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	MOV  R5,R30
...
_0x4:
; 0000 0093 {
; 0000 0094 checa_boton();
	RCALL _checa_boton
; 0000 0095 PORTB=tabla7segmentos [var];
	RCALL SUBOPT_0x1
	LPM  R0,Z
	OUT  0x18,R0
; 0000 0096 PORTA = ~tabla7segmentos[var];
	RCALL SUBOPT_0x1
	LPM  R30,Z
	COM  R30
	OUT  0x1B,R30
; 0000 0097 if (boton_guarda==0) //Si se presiona el botón de guardar
	SBIC 0x13,1
	RJMP _0x7
...
_0xD:
; 0000 00A3 {
; 0000 00A4 var++; //Se incrementa la variable
	INC  R5
; 0000 00A5 if (var>=10)
	LDI  R30,LOW(10)
	CP   R5,R30
...
_0xE:
	...
	RCALL _delay_ms
; 0000 00A8 }
; 0000 00A9 if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0xB:
	SBRC R2,0
	RJMP _0x10
	SBRC R2,1
