...
; 0000 003C DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 003D // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 003E PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 003F 
...
_0x11:
	BLD  R2,1
; 0000 0093 
; 0000 0094 if((botonp == 1) && (botona == 0)){ //Flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,1
	RJMP _0xA
...
; 0000 009D }
; 0000 009E 
; 0000 009F if((botonp == 0) && (botona == 1)) //Flanco de 0 a 1
_0x8:
	SBRC R2,0
	RJMP _0xE
	SBRC R2,1
...
; 0000 00A0 delay_ms(40);
	...
	RCALL _delay_ms
; 0000 00A1 
; 0000 00A2 PORTB = tabla7segmentos[decenas];
_0xD:
	MOV  R30,R4
	LDI  R31,0
	...
	LPM  R0,Z
	OUT  0x18,R0
; 0000 00A3 PORTA = ~tabla7segmentos[unidades];
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_tabla7segmentos*2)
	SBCI R31,HIGH(-_tabla7segmentos*2)
