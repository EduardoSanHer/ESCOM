...
_secuencia3_fila:
	.DB  0x7E,0x7D,0x7B,0x77,0x6F,0x5F,0x3F
_numeros:
	...
	.DB  0x36,0x41
_escum:
	.DB  0x0,0x36,0x36,0x36,0x36,0x7F,0x31,0x36
	.DB  0x36,0x36,0x46,0x7F,0x41,0x3E,0x3E,0x3E
	.DB  0x3E,0x7F,0x41,0x3E,0x3E,0x3E,0x41,0x7F
	.DB  0x0,0x7D,0x7B,0x7D,0x0,0x7F
_tbl10_G102:
...
; 0000 00C0 PORTC = secuencia3_columna[i];
	MOVW R30,R4
	SUBI R30,LOW(-_secuencia3_columna*2)
	SBCI R31,HIGH(-_secuencia3_columna*2)
	LPM  R0,Z
	OUT  0x15,R0
...
; 0000 00C9 PORTD = numeros[i][j];
	...
	LDI  R27,HIGH(5)
	RCALL __MULW12U
	SUBI R30,LOW(-_numeros*2)
	SBCI R31,HIGH(-_numeros*2)
	ADD  R30,R6
	ADC  R31,R7
	RCALL SUBOPT_0x8
...
; 0000 00D7 PORTD = escum[j+k];
	...
	ADD  R30,R6
	ADC  R31,R7
	SUBI R30,LOW(-_escum*2)
	SBCI R31,HIGH(-_escum*2)
	RCALL SUBOPT_0x8
...
SUBOPT_0x6:
	MOVW R30,R6
	SUBI R30,LOW(-_secuencia3_fila*2)
	SBCI R31,HIGH(-_secuencia3_fila*2)
	LPM  R0,Z
	OUT  0x12,R0
	RET
