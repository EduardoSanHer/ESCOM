...
; 0000 0094 delay_ms(25);
	...
	RCALL SUBOPT_0x0
; 0000 0095 Salida = 0;
; 0000 0096 delay_ms(475);
	LDI  R26,LOW(475)
	LDI  R27,HIGH(475)
	RJMP _0x30
; 0000 0097 } else if(Reversa == 0){
_0x6:
	SBIC 0x16,1
	RJMP _0xC
; 0000 0098 Salida = 1;
...
; 0000 0099 delay_ms(50);
	...
	RCALL SUBOPT_0x0
; 0000 009A Salida = 0;
; 0000 009B delay_ms(450);
	LDI  R26,LOW(450)
	LDI  R27,HIGH(450)
	RJMP _0x30
; 0000 009C } else if(Izquierda == 0){
_0xC:
	SBIC 0x16,2
	RJMP _0x12
; 0000 009D Salida = 1;
	SBI  0x1B,0
; 0000 009E delay_ms(75);
	LDI  R26,LOW(75)
	RCALL SUBOPT_0x0
; 0000 009F Salida = 0;
; 0000 00A0 delay_ms(425);
	LDI  R26,LOW(425)
	LDI  R27,HIGH(425)
	RJMP _0x30
; 0000 00A1 } else if(Derecha == 0){
_0x12:
	SBIC 0x16,3
	RJMP _0x18
; 0000 00A2 Salida = 1;
...
; 0000 00A3 delay_ms(100);
	...
	RCALL SUBOPT_0x0
; 0000 00A4 Salida = 0;
; 0000 00A5 delay_ms(400);
	LDI  R26,LOW(400)
	LDI  R27,HIGH(400)
	RJMP _0x30
; 0000 00A6 } else if(Pause == 0){
_0x18:
	SBIC 0x16,4
	RJMP _0x1E
; 0000 00A7 Salida = 1;
	SBI  0x1B,0
; 0000 00A8 delay_ms(125);
	LDI  R26,LOW(125)
	RCALL SUBOPT_0x0
; 0000 00A9 Salida = 0;
; 0000 00AA delay_ms(375);
	LDI  R26,LOW(375)
	LDI  R27,HIGH(375)
	RJMP _0x30
; 0000 00AB } else if(Delete == 0){
_0x1E:
	SBIC 0x16,5
	RJMP _0x24
; 0000 00AC Salida = 1;
	SBI  0x1B,0
; 0000 00AD delay_ms(150);
	LDI  R26,LOW(150)
	RCALL SUBOPT_0x0
; 0000 00AE Salida = 0;
; 0000 00AF delay_ms(350);
	LDI  R26,LOW(350)
	LDI  R27,HIGH(350)
	RJMP _0x30
; 0000 00B0 } else if(Go == 0){
_0x24:
	SBIC 0x16,6
	RJMP _0x2A
; 0000 00B1 Salida = 1;
	SBI  0x1B,0
; 0000 00B2 delay_ms(175);
	LDI  R26,LOW(175)
	RCALL SUBOPT_0x0
; 0000 00B3 Salida = 0;
; 0000 00B4 delay_ms(325);
	LDI  R26,LOW(325)
	LDI  R27,HIGH(325)
_0x30:
	RCALL _delay_ms
