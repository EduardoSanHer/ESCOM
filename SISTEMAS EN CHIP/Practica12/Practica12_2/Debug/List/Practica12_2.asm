...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	...
	.DEF _aux=R8
	.DEF _aux_msb=R9
	.DEF _num_secuencias=R10
	.DEF _num_secuencias_msb=R11
...
; 0000 0038 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0039 
...
_0x3:
; 0000 0094 {
; 0000 0095 contador = 0;
	CLR  R4
	CLR  R5
; 0000 0096 for(i = 0; i < 500; i++){
	CLR  R6
	CLR  R7
_0x7:
	LDI  R30,LOW(500)
...
_0x8:
; 0000 009B 
; 0000 009C if(contador >= 15 && contador <= 35){
	LDI  R30,LOW(15)
	LDI  R31,HIGH(15)
	RCALL SUBOPT_0x0
	BRLT _0xB
...
_0xB:
	RJMP _0xA
_0xC:
; 0000 009D //if(NumElems(secuencia) != 10)
; 0000 009E if(num_secuencias <= 10){
	RCALL SUBOPT_0x2
	BRLT _0xD
; 0000 009F //secuencia = push(Delante,secuencia);
; 0000 00A0 secuencia[num_secuencias] = Delante;
	RCALL SUBOPT_0x3
	LDI  R30,LOW(5)
	RCALL SUBOPT_0x4
; 0000 00A1 num_secuencias++;
; 0000 00A2 }
; 0000 00A3 //PORTA = Delante;
; 0000 00A4 }else if(contador >= 40 && contador <= 60){
_0xD:
	RJMP _0xE
_0xA:
	LDI  R30,LOW(40)
...
_0x10:
	RJMP _0xF
_0x11:
; 0000 00A5 //if(NumElems(secuencia) != 10)
; 0000 00A6 if(num_secuencias <= 10){
	RCALL SUBOPT_0x2
	BRLT _0x12
; 0000 00A7 //secuencia = push(Reversa,secuencia);
; 0000 00A8 secuencia[num_secuencias] = Reversa;
	RCALL SUBOPT_0x3
	LDI  R30,LOW(10)
	RCALL SUBOPT_0x4
; 0000 00A9 num_secuencias++;
; 0000 00AA }
; 0000 00AB //PORTA = Reversa;
; 0000 00AC }else if(contador >= 65 && contador <= 85){
_0x12:
	RJMP _0x13
_0xF:
	LDI  R30,LOW(65)
...
_0x15:
	RJMP _0x14
_0x16:
; 0000 00AD //if(NumElems(secuencia) != 10)
; 0000 00AE if(num_secuencias <= 10){
	RCALL SUBOPT_0x2
	BRLT _0x17
; 0000 00AF //secuencia = push(Izquierda,secuencia);
; 0000 00B0 secuencia[num_secuencias] = Izquierda;
	RCALL SUBOPT_0x3
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x4
; 0000 00B1 num_secuencias++;
; 0000 00B2 }
; 0000 00B3 //PORTA = Izquierda;
; 0000 00B4 }else if(contador >= 90 && contador <= 110){
_0x17:
	RJMP _0x18
_0x14:
	LDI  R30,LOW(90)
...
_0x1A:
	RJMP _0x19
_0x1B:
; 0000 00B5 //if(NumElems(secuencia) != 10)
; 0000 00B6 if(num_secuencias <= 10){
	RCALL SUBOPT_0x2
	BRLT _0x1C
; 0000 00B7 //secuencia = push(Derecha,secuencia);
; 0000 00B8 secuencia[num_secuencias] = Derecha;
	RCALL SUBOPT_0x3
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x4
; 0000 00B9 num_secuencias++;
; 0000 00BA }
; 0000 00BB //PORTA = Derecha;
; 0000 00BC }else if(contador >= 115 && contador <= 135){
_0x1C:
	RJMP _0x1D
_0x19:
	LDI  R30,LOW(115)
...
_0x1F:
	RJMP _0x1E
_0x20:
; 0000 00BD PORTA = 0x00;
	RJMP _0x2F
; 0000 00BE }else if(contador >= 140 && contador <= 160){
_0x1E:
	LDI  R30,LOW(140)
	LDI  R31,HIGH(140)
	RCALL SUBOPT_0x0
...
; 0000 00BF PORTA = 0x00;
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 00C0 for(aux = 0; aux < num_secuencias; aux++)
	CLR  R8
	CLR  R9
_0x26:
	__CPWRR 8,9,10,11
	BRGE _0x27
; 0000 00C1 secuencia[aux] = 0x00;
	LDI  R26,LOW(_secuencia)
	LDI  R27,HIGH(_secuencia)
	ADD  R26,R8
	ADC  R27,R9
	LDI  R30,LOW(0)
	ST   X,R30
	...
	RJMP _0x26
_0x27:
; 0000 00C2 num_secuencias = 0;
	CLR  R10
	CLR  R11
; 0000 00C3 }else if(contador >= 165 && contador <= 185){
	RJMP _0x28
_0x22:
	LDI  R30,LOW(165)
	LDI  R31,HIGH(165)
...
_0x2B:
; 0000 00C4 //aux = 0;
; 0000 00C5 //while(aux < num_secuencias && !pause){
; 0000 00C6 if(num_secuencias > 0){
	CLR  R0
	CP   R0,R10
	CPC  R0,R11
	BRGE _0x2C
; 0000 00C7 PORTA = secuencia[num_secuencias-1];
	RCALL SUBOPT_0x5
	LD   R30,Z
	OUT  0x1B,R30
; 0000 00C8 //PORTA = secuencia[aux];
; 0000 00C9 delay_ms(500);
	LDI  R26,LOW(500)
	LDI  R27,HIGH(500)
	RCALL _delay_ms
; 0000 00CA secuencia[num_secuencias-1] = 0x00;
	RCALL SUBOPT_0x5
	LDI  R26,LOW(0)
	STD  Z+0,R26
; 0000 00CB num_secuencias--;
	MOVW R30,R10
	SBIW R30,1
	MOVW R10,R30
; 0000 00CC //aux++;
; 0000 00CD }
; 0000 00CE PORTA = 0x00;
_0x2C:
; 0000 00CF //PORTA = Derecha;
; 0000 00D0 }
; 0000 00D1 else {
_0x29:
...
SUBOPT_0x5:
	MOVW R30,R10
	SBIW R30,1
	SUBI R30,LOW(-_secuencia)
	SBCI R31,HIGH(-_secuencia)
	RET
