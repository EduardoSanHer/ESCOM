...
; 0000 003C PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 003D 
...
_0xD:
	BLD  R2,1
; 0000 0091 
; 0000 0092 if((botona == 0) && (botonp == 1)) //Flanco de 1 a 0
	SBRC R2,1
	RJMP _0x9
	SBRC R2,0
	RJMP _0xA
...
; 0000 0093 variable++;
	INC  R5
; 0000 0094 
; 0000 0095 if(variable == 10)
_0x8:
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0xB
; 0000 0096 variable = 0;
	CLR  R5
; 0000 0097 
; 0000 0098 PORTB = tabla7segmentos[variable];
_0xB:
	RCALL SUBOPT_0x0
	LPM  R0,Z
	OUT  0x18,R0
; 0000 0099 PORTA = ~tabla7segmentos[variable];
	RCALL SUBOPT_0x0
	LPM  R30,Z
	COM  R30
	OUT  0x1B,R30
; 0000 009A botonp = botona;
	BST  R2,1
	BLD  R2,0
; 0000 009B 
; 0000 009C }
