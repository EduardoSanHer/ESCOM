...
// State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=0 Bit1=0 Bit0=0 
PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
...
//Se prueba la primera columna se env�a 110
PORTC=0b00111110;
...
if (lectura==0b00011000)
    tecla=9;
//se prueba segunda columna se env�a 101
PORTC=0b00111101;
//C3, C4 y C5 son las entradas del teclado
//Por eso se enmascaran con 00111000
lectura=PINC&0b00111000;
...
if (lectura==0b00011000)
    tecla=6;
//se prueba tercera columna se env�a 011
PORTC=0b00111011;
//C3, C4 y C5 son las entradas del teclado
//Por eso se enmascaran con 00111000
lectura=PINC&0b00111000;
