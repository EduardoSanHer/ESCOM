...
; 0000 0031 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(7)
	OUT  0x14,R30
; 0000 0032 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=0 Bit1=0 Bit0=0
; 0000 0033 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(248)
	OUT  0x15,R30
; 0000 0034 
...
_0x3:
; 0000 0089 {
; 0000 008A //C0 A C2 son de salida y son para
; 0000 008B //Probar las 3 columnas
; 0000 008C //Se prueba la primera columna se env�a 110
; 0000 008D PORTC=0b00111110;
	LDI  R30,LOW(62)
	RCALL SUBOPT_0x0
; 0000 008E //C3, C4 y C5 son las entradas del teclado
; 0000 008F //Por eso se enmascaran con 00111000
; 0000 0090 lectura=PINC&0b00111000;
; 0000 0091 if (lectura==0b00110000)
	BRNE _0x6
; 0000 0092 tecla=7;
	LDI  R30,LOW(7)
	MOV  R5,R30
; 0000 0093 if (lectura==0b00101000)
_0x6:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0x7
; 0000 0094 tecla=8;
	LDI  R30,LOW(8)
	MOV  R5,R30
; 0000 0095 if (lectura==0b00011000)
_0x7:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0x8
; 0000 0096 tecla=9;
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0097 //se prueba segunda columna se env�a 101
; 0000 0098 PORTC=0b00111101;
_0x8:
	LDI  R30,LOW(61)
	RCALL SUBOPT_0x0
; 0000 0099 //C3, C4 y C5 son las entradas del teclado
; 0000 009A //Por eso se enmascaran con 00111000
; 0000 009B lectura=PINC&0b00111000;
; 0000 009C if (lectura==0b00110000)
	BRNE _0x9
; 0000 009D tecla=4;
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 009E if (lectura==0b00101000)
_0x9:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xA
; 0000 009F tecla=5;
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 00A0 if (lectura==0b00011000)
_0xA:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xB
; 0000 00A1 tecla=6;
	LDI  R30,LOW(6)
	MOV  R5,R30
; 0000 00A2 //se prueba tercera columna se env�a 011
; 0000 00A3 PORTC=0b00111011;
_0xB:
	LDI  R30,LOW(59)
	RCALL SUBOPT_0x0
; 0000 00A4 //C3, C4 y C5 son las entradas del teclado
; 0000 00A5 //Por eso se enmascaran con 00111000
; 0000 00A6 lectura=PINC&0b00111000;
; 0000 00A7 if (lectura==0b00110000)
	BRNE _0xC
; 0000 00A8 tecla=1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 00A9 if (lectura==0b00101000)
_0xC:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xD
...
; 0000 00AC tecla=3;
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 00AD PORTB=tabla7segmentos [tecla];
_0xE:
	MOV  R30,R5
	LDI  R31,0
