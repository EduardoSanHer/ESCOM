...
#include <mega8535.h>
#include <delay.h>
#define boton_decrementa PIND.3
#define boton_incrementa PIND.2
bit botonp;
bit botona;
bit botonp2;
bit botona2;
...
void checa_boton_subida (void);
void checa_boton_bajada (void);
...
void checa_boton_subida (void){
      if (boton_incrementa==0)
            botona2=0;
      else
            botona2=1;
      if ((botonp2==1)&&(botona2==0)) //hubo cambio de flanco de 1 a 0
      {
            delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      }
      if ((botonp2==0)&&(botona2==1)) //hubo cambio de flanco de 0 a 1
      {
            var++; //Se decrementa la variable
            if (var>=10)
                  var=0;
            delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
      }
