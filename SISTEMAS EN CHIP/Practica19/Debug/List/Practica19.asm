...
; 0000 001B numero++;
	INC  R5
; 0000 001C if (numero == 10) numero = 0;
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x3
	CLR  R5
...
; .FSTART _ext_int1_isr
	RCALL SUBOPT_0x0
; 0000 0024 if (numero == 0) numero = 9;
	TST  R5
	BRNE _0x4
	LDI  R30,LOW(9)
	MOV  R5,R30
...
; 0000 0077 // INT0: On
; 0000 0078 // INT0 Mode: Rising Edge
; 0000 0079 // INT1: On
...
; 0000 0082 // INT0: On
; 0000 0083 // INT0 Mode: Rising Edge
; 0000 0084 // INT1: On
; 0000 0085 // INT1 Mode: Rising Edge
; 0000 0086 // INT2: Off
; 0000 0087 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 0088 MCUCR=(1<<ISC11) | (1<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(15)
	OUT  0x35,R30
; 0000 0089 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 008A GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 008B 
...
_0x5:
; 0000 00A9 {
; 0000 00AA PORTB = tabla7segmentos[numero];
	MOV  R30,R5
	LDI  R31,0
