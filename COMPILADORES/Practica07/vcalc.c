...
/*|----------------------------------------------------|*/
/*
    Función que recibe como parámetro dos vectores
    retornando un booleado dependiendo si son iguales
*/
/*|----------------------------------------------------|*/
int vectoresIgual(Vector *a, Vector *b){
    int aux=a->n==b->n;
    if(!aux)
        printf("Vectores de dimension diferente\n");
    return aux;
}